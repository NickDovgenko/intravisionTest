//
//  DetailDilerTableViewController.swift
//  intravisionTest
//
...
class DetailDilerTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "returnDataDiler" {
            ...
            print(detail)
            destViewController.diler = detail
        }
    }
