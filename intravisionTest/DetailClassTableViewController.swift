//
//  DetailCityClassDilerTableViewController.swift
//  intravisionTest
//
//  Created by Nick on 12.11.16.
//  Copyright © 2016 Nick. All rights reserved.
//

import UIKit

class DetailClassTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "returnDataClass" {
            ...
            print(detail)
            destViewController.autoClass = detail
        }
    }
